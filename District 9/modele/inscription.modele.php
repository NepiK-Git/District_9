...
function insert($pseudo, $firstName, $lastName, $datenaiss, $email, $telephone, $mdp) {
	global $bdd;
	$insertion = $bdd->prepare("INSERT INTO users (pseudo, firstName, lastName, datenaiss, email, telephone, mdp, lvl) 
        VALUES (:pseudo, :firstName, :lastName, :datenaiss, :email, :telephone, :mdp, 1)");
